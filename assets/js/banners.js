...
const BANNERS = [
  ...
  },
  {
    ...
    lines: [
      ...
      "Carl Fredrik Emrik, Cecilia Sterner",
      "Chris Shields, DINA, Dungeon Acid",
      "Eli Frankel & Dmn7 & Hannes Ferm",
      "Ellinor Åslund, EMG Trio",
      "Emil Keller Skousen, Fauna",
      "Francis Patrick Brady & TFK",
      "Frans Felix Ahlberg Eriksson",
      "Fulvio Castelli, Jenny Palén",
      "Jenny Seth, Johnny Essing",
      "Jonathan Sendborn Pohlin, Jules Reidy",
      "Kalevi Palomäki, Kristoffer Grip",
      "Lashing Chain, Mohammad Reza Mortazavi",
      "Nils Bergendal, One secret each",
      "Patrik Söderstam, Praktikantgruppen",
      "Private Parts, Rebecca Moss, SMiSK",
      "Snejina Latev, Stina Force, Tommie X",

...
// Diagonal braces — every 3rd level to avoid visual clutter
...
// Varied staircase — one flight per level, each at a different bay.
// Exports stairPath so the FPV walker can follow it.
...
// =====================================================
// SCATTERED PLATFORMS — irregular walkways between stages
// =====================================================
{
  let _ps = 31;
  const prand = () => {
...
// =====================================================
// COLORED GLASS PANELS — stained-glass sheets on scaffold faces
// =====================================================
